...
rem SET TODAY=%date:~3,2%-%date:~0,2%-%date:~6,4%-%hr%%time:~3,2%%time:~6,3%
@rem original Set TODAY=%date:~4,2%-%date:~7,2%-%date:~10,4%-%hr%%time:~3,2%%time:~6,2%%time:~9,2%

rem set year=%date:~-4,4%
rem set month=%date:~-10,2%
rem set day=%date:~-7,2%
rem set hour=%time:~-11,2%
rem set hour=%hour: =0%
rem set min=%time:~-8,2%
