...
MOV DH, 0; iniciamos en la fila 0 

LFILA: ; recorro las filas
    ; recorrer la columna
    MOV DL, 0 ; importante inicializar porque este codigo se repite muchas veces
    ; ya que esta dentro del loop LFILA
    LCOL:
        ; colocar el cursor donde queremos leer
        MOV AH, 2       ; establecer posicion del cursor
        ; ya modifico esto directamente
        ...
        INC DL ; pasamos a la siguiente columna
        CMP DL, 80 ; contamos solo hasta 79
        JL LCOL; finmientras
    ...
    INC DH; pasamos a la proxima fila
    CMP DH, 25 ; comprobamos si llego al final
