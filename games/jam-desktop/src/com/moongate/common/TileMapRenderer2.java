 ...
 * @author David Fraska */
public class TileMapRenderer2 implements Disposable {
	...
	public TileMapRenderer2 (TiledMap map, TileAtlas atlas, int tilesPerBlockX, int tilesPerBlockY) {
	...
	public TileMapRenderer2 (TiledMap map, TileAtlas atlas, int tilesPerBlockX, int tilesPerBlockY, float unitsPerTileX,
		float unitsPerTileY) {
	...
	public TileMapRenderer2 (TiledMap map, TileAtlas atlas, int tilesPerBlockX, int tilesPerBlockY, ShaderProgram shader) {
	 ...
	 * @param tilesPerBlockX The width of each block to be drawn, in number of tiles
	 * @param tilesPerBlockY The height of each block to be drawn, in number of tiles */
	public TileMapRenderer2 (int[][][] map, TileAtlas atlas, int tileWidth, int tileHeight, float unitsPerTileX,
